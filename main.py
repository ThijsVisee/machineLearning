...
def neural_network():
    ...
    duration_model = nn_model(df_train=train_df, df_val=val_df, input_shape=input_shape,
                              output_shape=output_shape_duration,
    ...
    return write_voice_to_file(df=df, filename=f'voice')
...
if __name__ == '__main__':
    ...
    if (play_single_voice):
        play_voice(np.array(prediction))
